...
- (void)setupViewWindowWidth:(CGFloat)windowWidth
{
    /*
    // Default values
    kCircleBackgroundTopPosition = -25.0f;
    kCircleHeight = 46.0f;
    kCircleHeightBackground = 56.0f;
...
- (void)addTimerToButtonIndex:(NSInteger)buttonIndex reverse:(BOOL)reverse
{
    ...
    buttonTimer = [[SCLTimerDisplay alloc] initWithOrigin:CGPointMake(5, 5) radius:13 lineWidth:2];
