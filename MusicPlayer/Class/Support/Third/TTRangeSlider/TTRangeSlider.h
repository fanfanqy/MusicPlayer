 ...
 */
@property (nonatomic, assign) IBInspectable BOOL disableRange;// 此属性等同于 disableLeftHandle


/*!
 @brief  <#简要描述#>
 */
@property (nonatomic, assign) IBInspectable BOOL disableRightHandle;
...
/*!
 @brief  <#简要描述#>
 */
@property (nonatomic, strong)  UIColor *tintColorLineOnLeftHandle;
